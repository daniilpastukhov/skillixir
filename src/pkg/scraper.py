...
class Scraper:
    def __init__(self,
        ...
        print(on_error_callback or self.__default_error_callback)
    ...
    def __default_data_callback(self, data):
        logger.info(f'Scraped {data.title} {data.company} {data.company_link} {data.date} {data.link} {data.insights} {len(data.description)}')
